...
const documents = [
...

    {
        ...
        description: 'Detailed project proposal outlining IEMS objectives, methodology, and expected outcomes.',
        type: 'document',
        date: 'August 2024',
        ...
        status: 'available',
        category: 'Individual',
        downloadUrl: 'https://drive.google.com/drive/folders/1UARxuchamGO5lNQujftPSUWakYmfhf4b?usp=sharing'
    },
    {
    ...
    },
    {
        ...
        status: 'available',
        category: 'Individual',
        downloadUrl: 'https://drive.google.com/drive/folders/1EupcaNopdoVmreDsozwdWY3dR1B46-V0?usp=sharing'
    },
...
const presentations = [
    {
        title: 'Project Proposal',
        description: 'Initial project presentation outlining IEMS concept and development plan.',
        type: 'presentation',
        date: 'August 2024',
    ...
    },
    {
        ...
        description: 'Comprehensive final presentation covering complete IEMS implementation and evaluation.',
        type: 'presentation',
        date: 'May 2025',
                                        ...
                                        {doc.status === 'available' ? (
                                            <>
                                                ...
                                                >
                                                    ...
                                                    {doc.downloadUrl.includes('drive.google.com') ? 'Open Drive' : 'Download'}
                                                </motion.button>
                                                <motion.button
                                                    whileHover={{ scale: 1.02 }}
                                                    whileTap={{ scale: 0.98 }}
