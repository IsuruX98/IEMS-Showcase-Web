...
const technologyCategories = [
    ...
    {
        category: 'IoT & Sensor Technologies',
        icon: DevicePhoneMobileIcon,
        technologies: [
            { name: 'Arduino & ESP32', icon: null, description: 'IoT microcontrollers' },
            { name: 'MQ-135', icon: null, description: 'CO₂/NOx detection sensor' },
            { name: 'SDS011', icon: null, description: 'Laser-based PM2.5 sensor' },
            { name: 'DHT22', icon: null, description: 'Digital temp & humidity sensor' },
            { name: 'Calibrated Microphones', icon: null, description: 'Noise monitoring sensors' },
            { name: 'Wi-Fi & LoRa', icon: null, description: 'Connectivity protocols' },
        ],
    ...
    },
    {
        ...
        icon: CloudIcon,
        technologies: [
            { name: 'MongoDB', icon: SiMongodb, description: 'Primary NoSQL database' },
                ...
                >
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
                            Technologies Powering IEMS
                        </h2>
                        <div className="w-20 h-0.5 bg-green-500/50 mx-auto rounded-full mb-6"></div>
                        <p className="text-gray-300 text-lg max-w-4xl mx-auto leading-relaxed">
                            The Intelligent EcoUrban Monitoring System (IEMS) leverages a sophisticated and modern technology stack,
