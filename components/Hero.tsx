    ...
    return (
        <section className="min-h-screen flex items-center justify-center pt-16 relative">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/images/environmental-bg.webp')",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <p className="text-lg sm:text-xl text-gray-300 max-w-4xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4">
                        Rapid urbanization brings progress but also complex environmental challenges. IEMS is a revolutionary platform
                        that integrates cutting-edge AI, IoT, and data analytics to provide comprehensive, real-time, and predictive
                        insights into urban air quality, noise pollution, green space dynamics, and vehicle CO₂ emissions.
                    </p>
